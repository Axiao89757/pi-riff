...
- Tool calls form compact batches separated from assistant text
- Thinking shows only current progress while streaming, collapses to a timed step count, and expands in Full mode
